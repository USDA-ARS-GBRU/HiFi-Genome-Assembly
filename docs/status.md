...
- [x] Add repeat release-mask decision case or packet-closing summary.

Current v0.7 assessment: coherent first-draft packet complete.
...
- [x] Add worked gene-set disagreement case.
- [x] Add hard case for ID preservation versus supported novel-locus recovery.

Current v0.8 assessment: coherent first-draft packet complete.
