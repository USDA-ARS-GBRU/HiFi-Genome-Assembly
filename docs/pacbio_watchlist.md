...
| https://github.com/PacificBiosciences/pbipa | PacBio IPA/pbipa assembler. Useful as an optional comparison path when locally available. |
...
- New PacBio or hifiasm guidance on HiFi plus ONT hybrid assembly, hifiasm-UL, or near-T2T workflows.
- Changes to pbipa availability, installation, or recommended use.
...
- Treat pbipa as an optional comparison assembler where installation and support are clear, not as the default crop HiFi lane.
